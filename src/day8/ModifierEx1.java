...
class C extends B{
	...
	public C(int num) {
		//final 멤버 변수는 선언과 동시에 초기화 하지 않아도 초기화를 생성자에서 할 수있다.
		this.num =num;
	}
}
class D{
	//매개변수 클래스  Object의 객체 obj가 오면 실제 넣어주는 정보는
	...
	//실제 넣어주는 정보는 b클래스의 객체나 b클래스를 상속받은 A객체를 매개변수로 넣어줄 수있다.
